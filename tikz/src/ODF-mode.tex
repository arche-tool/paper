...
\nextgroupplot[]
  ...
  \node[small dot, pin={45:\begin{tabular}{c} $g_{A}$ \\ variant 1\end{tabular}}] at (axis cs:\gbva, 0.8) {};
  \node[small dot, pin={45:\begin{tabular}{c} $g_{A}$ \\ variant 6\end{tabular}}] at (axis cs:\gbvb, 0.8) {};
  \node[small dot, pin={45:\begin{tabular}{c} $g_{A}$ \\ variant 4\end{tabular}}] at (axis cs:\gbvc, 0.8) {};
...
\nextgroupplot[]
  ...
  \node[small dot, pin={135:\begin{tabular}{c} $g_{B}$ \\ variant 9\end{tabular}}] at (axis cs:\grva, 0.8) {};
  \node[small dot, pin={ 45:\begin{tabular}{c} $g_{C}$ \\ variant 5\end{tabular}}] at (axis cs:\ggva, 0.8) {};
  \node[small dot, pin={ 45:\begin{tabular}{c} $g_{B}$ \\ variant 2\end{tabular}}] at (axis cs:\grvb, 0.8) {};

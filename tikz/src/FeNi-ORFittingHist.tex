...
\def \plotdata[#1] {
    \addplot[blue, fill=blue, fill opacity=0.2, bar width=#1] table [x index=0, y index=4, col sep=tab] {../data/ORFit/FeNi-OR-Hist.csv};
    \addplot[red, fill=red, fill opacity=0.2, bar width=#1] table [x index=0, y index=6, col sep=tab] {../data/ORFit/FeNi-OR-Hist.csv};
}

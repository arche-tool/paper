...
\begin{table}[t]
  ...
  \hline\hline
      ...
      $\langle0.97\,0.18\,0.18\rangle\:42.85^\circ$ &
      ...
      $\langle0.98\,0.08\,0.20\rangle\:45.98^\circ$ &
      $\{1\,1\,1\}_{\gamma} || \{1\,1\,0\}_{\alpha}$ &
      $\langle1\,1\,2\rangle_{\gamma} || \langle1\,1\,0\rangle_{\alpha}$ \\
      
      Greninger and Troiano \cite{greninger1949mechanism} &
      $\langle0.98\,0.20\,0.98\rangle\:44.23^\circ$ &
      $\{1\,1\,1\}_{\gamma} || \{1\,1\,0\}_{\alpha}$ &
      $\langle1\,2\,3\rangle_{\gamma} || \langle1\,3\,3\rangle_{\alpha}$ \\
      
      Pitsch \cite{pitsch1962orientierungszusammenhang} &
      $\langle0.98\,0.20\,0.08\rangle\:45.98^\circ$ &
      $\{1\,0\,0\}_{\gamma} || \{1\,1\,0\}_{\alpha}$ &
      $\langle1\,1\,0\rangle_{\gamma} || \langle1\,1\,1\rangle_{\alpha}$ \\
  \hline
  \end{tabular}
  \caption{\label{tab:ORs}Different orientation relationships $T^{\alpha'\leftrightarrow\gamma}$ for martensitic transformation in steels reported in the literature.}
  \end{table}
